  ...
  return (
    <div className="gap-1 px-6 flex flex-1 justify-center py-5">
      <div className="layout-content-container flex flex-col max-w-[920px] flex-1">
        ...
        <p className="text-[#60768a] text-base font-normal leading-normal pb-3 pt-1 px-4 text-center">Describe your idea in detail</p>
        ...
        {(loading || analysisResult) && (
          <div className="flex flex-col w-full items-center">
            <div className="layout-content-container flex flex-col w-full border-t border-solid border-l-[#f1f2f4] pt-5 mt-5">
              <h2 className="text-[#121416] text-[22px] font-bold leading-tight tracking-[-0.015em] px-4 pb-3 text-center">Patentability Report</h2>
